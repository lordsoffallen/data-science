...
U, M = factor.low_rank_matrix_factorization(ratings_df.values,
                                            num_features=15,
                                            regularization_amount=1.0)
# U = NUM_USERS x 15 , M = 15 x MOVIE_SIZE
...
# This is an important point to do before summing!!
...
# Remember to remove 1 movies because that's the movie itself.
